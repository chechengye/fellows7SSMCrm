...
<%@ taglib prefix="lc" uri="http://lovecoding/utils/"%>
<%
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/getCustomerList.do" method="post">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<lc:page url="${pageContext.request.contextPath }/getCustomerList.do" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
